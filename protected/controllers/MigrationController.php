...
class MigrationController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('Migration');
	 ...
	 * @param Migration $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='migration-form')
		{
